...
var healthyPictoGraph = '<DataTemplate xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" xmlns:sys="clr-namespace:System;assembly=mscorlib"><DataTemplate.Resources><sys:String x:Key="ratio">0.36226</sys:String><sys:String x:Key="vertSpacingHive">-0.6</sys:String><sys:String x:Key="horzSpacingHive">0.4</sys:String></DataTemplate.Resources><Viewbox ViewWidth="18" ViewHeight="49.688"><Grid><Path Stroke="{Binding Path=Stroke}" Fill="{Binding Path=Fill}" Reuse="true" Data="M5.5,0.5B5.5,0.5,8,8,0,360M18.458,15.348c-0.321-3.438-2.626-5.16-5.427-5.16H5.969c-2.801,0-5.105,1.723-5.427,5.161C0.517,15.458,0.5,15.57,0.5,15.688v14c0,0.828,0.672,1.5,1.5,1.5s1.5-0.672,1.5-1.5v-10.5h1v10v19c0,1.104,0.896,2,2,2s2-0.896,2-2v-17h2v17c0,1.104,0.896,2,2,2s2-0.896,2-2v-19v-10h1v10.5c0,0.828,0.672,1.5,1.5,1.5s1.5-0.672,1.5-1.5v-14C18.5,15.57,18.483,15.458,18.458,15.348z" ></Path></Grid></Viewbox></DataTemplate>';
...
if (gaugeTemplates != undefined) {
    ...
    gaugeTemplates.healthyLinearMarker = '<DataTemplate xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" xmlns:sys="clr-namespace:System;assembly=mscorlib">' +
                ...
                '</DataTemplate.Resources>' +
                '<Border Fill="{Binding Path=Fill}" CornerPercent="1" Stroke="{Binding Path=Stroke}" StartCorner="1" Segments="1"/>' +
            '</DataTemplate>';
    ...
    gaugeTemplates.healthyLinearBarRound = '<DataTemplate xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" xmlns:sys="clr-namespace:System;assembly=mscorlib">' +
        '<DataTemplate.Resources>' +
        	'<sys:String x:Key="clipBar">1</sys:String>' +
        '</DataTemplate.Resources>' +
    ...
    gaugeTemplates.healthyHorizontalFillerRound = '<DataTemplate xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" xmlns:sys="clr-namespace:System;assembly=mscorlib">' +
          '<Border Fill="{Binding Path=Fill}" CornerPercent="1" Stroke="{Binding Path=Stroke}" StartCorner="2" Segments="1"/>' +
        '</DataTemplate>';
    ...
    gaugeTemplates["TipBorderDefault"] = '<DataTemplate xmlns:x="a"><DataTemplate.Resources><MultiplyConverter x:Key="multConverter"/></DataTemplate.Resources><Canvas Padding="12"><Border Stroke="{Binding Path=Stroke}" StrokeThickness="3" CornerRadius="45" CornerPercent="1" Canvas.Top="2" Segments="7" StartCorner="2"></Border><Border BorderBrush="{Binding Path=Stroke}" BorderThickness="2" Background="{Binding Path=Fill}" CornerPercent="1" CornerRadius="45" Padding="4" Segments="7" StartCorner="2"><DockPanel x:Name="container" Margin="10,10,10,6" Orientation="Vertical"><TextBlock Text="{Binding Path=Title}" FontSize="{Binding Path=FontSize" Visible="{Binding Path=TitleVisible}" HorizontalAlignment="Right" FontWeight="Bold" Margin="3,0,3,0"/><Border Height="1" Stroke="{Binding Path=Foreground}" StrokeThickness="1" Margin="0,0,0,4" Visible="{Binding Path=TitleVisible}"/></DockPanel></Border></Canvas></DataTemplate>';

    gaugeTemplates.healthyPictoGraph = healthyPictoGraph;
    ...
    gaugePalette.setColors([
        ...
        "#BBBBBB",  // EmptyFill
        "#999999",  // EmptyBorder
        "#A8D350",   // Attribute0Fill       
        "#FDD25F",  // Attribute1Fill
        "#F47528",  // Attribute2Fill
        "#ED3B6B",  // Attribute3Fill
        "#4EC2C2",  // Attribute4Fill
        "#7E9F3C",   // Attribute0Stroke
        "#BE9E48",  // Attribute1Stroke
        "#B7581E",  // Attribute2Stroke
        "#B22D51",  // Attribute3Stroke
        "#3B9292"  // Attribute4Stroke
    ]);
...
if (chartTemplates != undefined) {
    ...
    chartTemplates.healthyBorder = '<DataTemplate xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" xmlns:sys="clr-namespace:System;assembly=mscorlib">' +
                      '<DataTemplate.Resources>' +
						...
						'<Thickness x:Key="uiMargin">18,17,0,0</Thickness>' +
    ...
    '<Path Data="{Binding Path=Geometry}" Fill="{Binding Path=Fill}" Stroke="{Binding Class=BorderEffect2.fill}" StrokeThickness="3"/>' +
    '</DataTemplate>';
    ...
    chartTemplates.healthyFunnel = '<DataTemplate xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" xmlns:sys="clr-namespace:System;assembly=mscorlib">' +
        '<Polygon Points="{Binding Path=PointsPolygon}" Fill="{Binding Path=Fill}" Stroke="{Binding Class=BorderEffect2.fill}" StrokeThickness="3"/>' +
    '</DataTemplate>';
    ...
    chartTemplates["TipBorderDefault"] = '<DataTemplate xmlns:x="a"><DataTemplate.Resources><MultiplyConverter x:Key="multConverter"/></DataTemplate.Resources><Canvas Padding="12"><Border BorderBrush="{Binding Path=ItemFillS}" BorderThickness="3" CornerRadius="45" CornerPercent="1" Canvas.Top="2" Segments="7" StartCorner="2"></Border><Border BorderBrush="{Binding Path=ItemFillS}" BorderThickness="2" Background="{Binding Path=Fill}" CornerPercent="1" CornerRadius="45" Padding="4" Segments="7" StartCorner="2"><DockPanel x:Name="container" Margin="10,10,10,6" Orientation="Vertical"><TextBlock Text="{Binding Path=Title}" FontSize="{Binding Path=FontSize" Visible="{Binding Path=TitleVisible}" HorizontalAlignment="Right" FontWeight="Bold" Margin="3,0,3,0"/><Border Height="1" Stroke="{Binding Path=Foreground}" StrokeThickness="1" Margin="0,0,0,4" Visible="{Binding Path=TitleVisible}"/></DockPanel></Border></Canvas></DataTemplate>';

    chartTemplates.healthyPictoGraph = healthyPictoGraph;
...
cfx.ToolTipAttributes.prototype.setLineMode = function ToolTipAttributes$setLineMode()
{
    ...
    lineMode.setBorderTemplate('<DataTemplate xmlns:x="a"><DataTemplate.Resources><MultiplyConverter x:Key="multConverter"/><Thickness x:Key="padding">2</Thickness></DataTemplate.Resources><Canvas Padding="{Binding Path=Padding}"><Border Canvas.Left="-1" Canvas.Top="0" Fill="{Binding Class=Border.fill}" Opacity="0.9" Stroke="{x:Null}"><DockPanel x:Name="container" Orientation="Vertical" Margin="2,2,2,2"><TextBlock Text="{Binding Path=Title}" FontSize="{Binding Path=FontSize, Converter={StaticResource multConverter},ConverterParameter=0.8}" Visible="{Binding Path=TitleVisible}" HorizontalAlignment="Left" FontWeight="Normal" Foreground="{Binding Class=DashboardTitle.fill}" VerticalAlignment="Center" Margin="10,3,3,3" /><Border Height="1" Stroke="{Binding Class=AxisY_Line.stroke}" StrokeThickness="1" Margin="10,0,10,4" Visible="{Binding Path=TitleVisible}"/></DockPanel></Border></Canvas></DataTemplate>');
