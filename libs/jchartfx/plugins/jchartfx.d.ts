declare module cfx {
    ...
    export class DockableBar {
        ...
        getExternalGap(): number;
        setExternalGap(value: number): void;
    }
    ...
    export class ConditionalAttributesCollection {
        ...
        setShowInLegend(value: boolean): void;
    ...
    export module annotation {
        ...
        export enum ColorTransformation {
            None,
            GrayScale,
            Colorize
        }
        ...
        export class AnnotationPicture extends AnnotationObject {
            ...
            /** Allows you to set the image for an annotation picture object. */
            setPicture(value: any): void;
            getTransformation(): ColorTransformation;
            setTransformation(value: ColorTransformation): void;
            getTransformationColor(): string;
            setTransformationColor(value: string): void;
            sizeToFit(): void;
        }
    ...
    export module maps {
        ...
        export class MapSurfaceGallery {
            constructor();
            getColors(): ColorGradientCollection;
            getExtendMethod(): SurfaceExtendMethod;
            setExtendMethod(value: SurfaceExtendMethod): void;
        }
        ...
        export class MapShape {
            ...
            getLabel(): string;
            getLabelAlignment(): MapLabelAlignment;
            setLabelAlignment(value: MapLabelAlignment): void;
    ...
    export module axistrend {
        export class AxisTrend extends IGalleryType {
            ...
            getColorGreaterThan(): string;
            setColorGreaterThan(value: string): void;
    ...
    export module financial {
        ...
        export class Study {
            ...
            getVisible(): boolean;
            setVisible(value: boolean): void;
            getItemPoint(point: number): number;
            getItemDate(date: any): number;
            getItem(series: number, point: number): number;
            getItemDateSeries(date: any, series: number): number;
        }
    ...
    export module sunburst {
        ...
        export class SunBurstElement {
        }

        export class SunBurstValue extends SunBurstElement {
            getBorderColor(): string;
            setBorderColor(value: string): void;
            getColor(): string;
            setColor(value: string): void;
            ...
            getLevel(): number;
            getParent(): SunBurstValue;
            getParentTotal(): number;
            getTextColor(): string;
            setTextColor(value: string): void;
            getValue(): number;
            setValue(value: number): void;
            getHighlightList(): any;
        }

        export class SunBurstColorKey extends SunBurstElement {
            getHighlightList(): any;
        }
        ...
        export class SunBurst extends IGalleryType {
            ...
            getGallery(): VectorDoughnut;
            getHoleRatio(): number;
            setHoleRatio(value: number): void;
            getLevels(): SunBurstLevelCollection;
            getShowAllInLegend(): boolean;
            setShowAllInLegend(value: boolean): void;
            getTemplate(): string;
            setTemplate(value: string): void;
    ...
    export module errorbar {
        export class ErrorBar extends IGalleryType {
            protected _internal_IGalleryType(): void;
            constructor();
            getCluster(): boolean;
            setCluster(value: boolean): void;
    ...
    export module waterfall {
        export class Waterfall extends IGalleryType {
            protected _internal_IGalleryType(): void;
            constructor();
            getColorGreaterThan(): string;
            setColorGreaterThan(value: string): void;
            ...
            getTemplate(): string;
            setTemplate(value: string): void;
            getUseValueOnFirst(): boolean;
            setUseValueOnFirst(value: boolean): void;
        }
    }
    ...
    export module gauge {
        ...
        export enum TrendAnimationStyle {
            Value,
            ColorPrimary
        }
        ...
        export class Trend extends BorderedControl {
            ...
            setLayoutStyle(value: number): void;
